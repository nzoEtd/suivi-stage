...
@Component({
  selector: 'app-modale-ajout-student',
  imports: [],
  templateUrl: './modale-ajout-student.component.html',
  styleUrl: './modale-ajout-student.component.css'
})
export class ModaleAjoutStudentComponent implements OnInit {
