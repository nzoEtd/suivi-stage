...
export class StudentStaffAcademicYearService {
  ...
  getAllStudentTeachers(
    fields?: string[],
  ): Observable<Student_Staff_AcademicYear_String[]> {
  ...
  getTutorByUppaAndYear(
    ...
    fields?: string[],
  ): Observable<Student_Staff_AcademicYear | undefined> {
    let params = new HttpParams();
  ...
  ): Observable<Student_Staff_AcademicYear> {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-type": "application/json" }),
    };

    return this.http
      .post<Student_Staff_AcademicYear>(
        `${this.apiUrl}/api/affectation/create`,
        affectation,
        httpOptions,
      )
      .pipe(
  ...
  updateStudentTeacherAssignments(
    affectation: Student_Staff_AcademicYear,
  ): Observable<Student_Staff_AcademicYear> {
    const httpOptions = {
      headers: new HttpHeaders({ "Content-type": "application/json" }),
    ...
    return this.http
      .put<Student_Staff_AcademicYear>(
        `${this.apiUrl}/api/affectation/update/${affectation.idPersonnel}-${affectation.idUPPA}-${affectation.idAnneeUniversitaire}`,
        affectation,
        httpOptions,
      )
      .pipe(
  ...
  runAlgorithm(idUPPA: string, idFicheDescriptive: number): Observable<string> {
    return this.http.get<string>(
      `${this.apiUrl}/api/run-algo/${idUPPA}-${idFicheDescriptive}`,
    );
  }
